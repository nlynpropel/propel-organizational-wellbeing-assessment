/*
# Fix: type mismatch in generate_recommendations concern matching

The concern/outcome matching query compared uuid o.id against a text array.
Fix by casting o.id to text.
*/
...
BEGIN
  ...
  -- Multi-select stores option IDs as comma-separated text in text_value
