...
BEGIN
  ...
  -- Version (draft)
  INSERT INTO public.assessment_versions (name, version_number, status, assessment_template_id, version_label, introduction_text, completion_message, scoring_method, show_overall_score, respondent_results_enabled, respondent_score_enabled, respondent_section_scores_enabled, respondent_recommendations_enabled)
  VALUES (
    'Propel Well-being Opportunity Index v1', 1, 'draft', v_template_id, 'v1.0',
  ...
  INSERT INTO public.assessment_questions (assessment_version_id, assessment_section_id, question_text, help_text, question_type, display_order, is_required, is_scored, weight, reverse_scored) VALUES (v_version_id, s2, 'How recently has the organization gathered employee input about well-being needs and barriers?', 'Consider surveys, focus groups, interviews, listening sessions, and other direct employee feedback.', 'custom_scored', 1, true, true, 1, false) RETURNING id INTO q5;
  INSERT INTO public.assessment_questions (assessment_version_id, assessment_section_id, question_text, help_text, question_type, display_order, is_required, is_scored, weight, reverse_scored) VALUES (v_version_id, s2, 'How well does programming reflect differences across employee groups?', 'Consider differences in need, role, location, work environment, schedule, and employee population.', 'custom_scored', 2, true, true, 1, false) RETURNING id INTO q6;
  INSERT INTO public.assessment_questions (assessment_version_id, assessment_section_id, question_text, help_text, question_type, display_order, is_required, is_scored, weight, reverse_scored) VALUES (v_version_id, s2, 'How much choice do employees have in how they participate?', 'Consider choice of topics, activities, goals, participation formats, and personalized pathways.', 'custom_scored', 3, true, true, 1, false) RETURNING id INTO q7;
  INSERT INTO public.assessment_questions (assessment_version_id, assessment_section_id, question_text, help_text, question_type, display_order, is_required, is_scored, weight, reverse_scored) VALUES (v_version_id, s2, 'How comprehensively does the strategy address employee well-being?', 'Consider physical, mental, financial, social, and other relevant dimensions of well-being.', 'custom_scored', 4, true, true, 1, false) RETURNING id INTO q8;
  ...
  INSERT INTO public.assessment_questions (assessment_version_id, assessment_section_id, question_text, help_text, question_type, display_order, is_required, is_scored, weight, reverse_scored) VALUES (v_version_id, s4, 'How easy is it for an employee to know where to begin?', 'Consider whether employees receive a clear, visible, and relevant starting point.', 'custom_scored', 1, true, true, 1, false) RETURNING id INTO q14;
  INSERT INTO public.assessment_questions (assessment_version_id, assessment_section_id, question_text, help_text, question_type, display_order, is_required, is_scored, weight, reverse_scored) VALUES (v_version_id, s4, 'How centralized are the organization''s well-being benefits and resources?', 'Consider the number of systems, access points, links, logins, and disconnected vendor experiences employees must navigate.', 'custom_scored', 2, true, true, 1, false) RETURNING id INTO q15;
  INSERT INTO public.assessment_questions (assessment_version_id, assessment_section_id, question_text, help_text, question_type, display_order, is_required, is_scored, weight, reverse_scored) VALUES (v_version_id, s4, 'How easy is it for employees to participate from mobile devices?', 'Consider accessibility, convenience, usability, and the ability to complete core activities from a mobile device.', 'custom_scored', 3, true, true, 1, false) RETURNING id INTO q16;
  INSERT INTO public.assessment_questions (assessment_version_id, assessment_section_id, question_text, help_text, question_type, display_order, is_required, is_scored, weight, reverse_scored) VALUES (v_version_id, s4, 'How accessible is the program to frontline, remote, shift, field, and deskless employees?', 'Consider access, communication, scheduling, technology, and work-environment barriers.', 'custom_scored', 4, true, true, 1, false) RETURNING id INTO q17;

  -- Section 5 Questions (18-21)
  INSERT INTO public.assessment_questions (assessment_version_id, assessment_section_id, question_text, help_text, question_type, display_order, is_required, is_scored, weight, reverse_scored) VALUES (v_version_id, s5, 'How well do managers reinforce employee well-being?', 'Consider manager communication, encouragement, role modeling, guidance, and accountability.', 'custom_scored', 1, true, true, 1, false) RETURNING id INTO q18;
  INSERT INTO public.assessment_questions (assessment_version_id, assessment_section_id, question_text, help_text, question_type, display_order, is_required, is_scored, weight, reverse_scored) VALUES (v_version_id, s5, 'How often do employees see relatable peers participating or succeeding?', 'Consider peer visibility, success stories, recognition, social participation, privacy, and inclusion.', 'custom_scored', 2, true, true, 1, false) RETURNING id INTO q19;
  INSERT INTO public.assessment_questions (assessment_version_id, assessment_section_id, question_text, help_text, question_type, display_order, is_required, is_scored, weight, reverse_scored) VALUES (v_version_id, s5, 'How clearly does the organization explain privacy and data protections?', 'Consider confidentiality, data collection, data use, access, and how these protections are communicated.', 'custom_scored', 3, true, true, 1, false) RETURNING id INTO q20;
  ...
  INSERT INTO public.assessment_questions (assessment_version_id, assessment_section_id, question_text, help_text, question_type, display_order, is_required, is_scored, weight, reverse_scored) VALUES (v_version_id, s6, 'How clearly has the organization defined its well-being performance measures?', 'Consider whether performance measures connect participation, engagement, behavior, health, and organizational outcomes with strategic objectives.', 'custom_scored', 1, true, true, 1, false) RETURNING id INTO q22;
  INSERT INTO public.assessment_questions (assessment_version_id, assessment_section_id, question_text, help_text, question_type, display_order, is_required, is_scored, weight, reverse_scored) VALUES (v_version_id, s6, 'How well can the organization distinguish awareness, registration, participation, and sustained engagement?', 'Consider whether the organization can identify where employees enter, progress through, and disengage from the participation funnel.', 'custom_scored', 2, true, true, 1, false) RETURNING id INTO q23;
  INSERT INTO public.assessment_questions (assessment_version_id, assessment_section_id, question_text, help_text, question_type, display_order, is_required, is_scored, weight, reverse_scored) VALUES (v_version_id, s6, 'How effectively does the organization identify differences in engagement across employee groups?', 'Consider comparisons by department, location, role, population, work environment, or other meaningful employee segment.', 'custom_scored', 3, true, true, 1, false) RETURNING id INTO q24;
  INSERT INTO public.assessment_questions (assessment_version_id, assessment_section_id, question_text, help_text, question_type, display_order, is_required, is_scored, weight, reverse_scored) VALUES (v_version_id, s6, 'How frequently does the organization use results to improve the strategy?', 'Consider whether results lead to testing, scheduled reviews, program changes, targeted adjustments, and continuous optimization.', 'custom_scored', 4, true, true, 1, false) RETURNING id INTO q25;
