/*
# Fix: correct column names in calculate_assessment_scores

The recreated function used wrong column names for assessment_score_bands.
Correct: band_name, min_threshold, max_threshold (not score_band, min_score, max_score).
Also fix assessment_question_driver_mappings column name if needed.
*/
...
BEGIN
  ...
  AND v_overall_norm >= min_threshold AND v_overall_norm <= max_threshold
